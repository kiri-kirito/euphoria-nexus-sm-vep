              ...
              {profileOpen && (
                <div className="absolute right-0 top-full mt-2 w-52 bg-white rounded-2xl shadow-xl border border-slate-200 overflow-hidden z-50">
                  ...
                  <div className="border-t border-slate-100 py-1">
                    <button onClick={() => { localStorage.removeItem('mockUserRole'); window.location.href = '/'; }} className="flex items-center gap-2.5 px-4 py-2.5 text-sm text-red-500 hover:bg-red-50 transition-colors w-full">
